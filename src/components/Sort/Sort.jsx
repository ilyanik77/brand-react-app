					...
					<div className='sort__box'>
						<div className='sort__check'>
							<label htmlFor='sort__check1'>
								<input className='sort__check1' type='checkbox' />
								XS
							</label>
							<label htmlFor='sort__check2'>
								<input className='sort__check2' type='checkbox' />S
							</label>
							<label htmlFor='sort__check3'>
								<input className='sort__check3' type='checkbox' />M
							</label>
							<label htmlFor='sort__check4'>
								<input className='sort__check4' type='checkbox' />L
							</label>
						</div>
					</div>
				</details>
