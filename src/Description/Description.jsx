    ...
    return (  
        <section class="description">
            ...
            <div class="description__content container">
                <img class="description__content__img" src="img/product13.png" alt="product13" />
                <div class="description__product">
                    ...
                    <p class="description__product__text">
                    ...
                    <p class="description__product__price">
                        $561
                    </p>
                            ...
                            <div class="sort__box">
                                <div class="sort__check">
                                    ...
                                    <label for="sort__check1">
                                        <input class="sort__check1" type="checkbox" />XS
                                    </label>
                                    <label for="sort__check2">
                                        <input class="sort__check2" type="checkbox" />S
                                    </label>
                                    <label for="sort__check3">
                                        <input class="sort__check3" type="checkbox" />M
                                    </label>
                                    <label for="sort__check4">
                                        <input class="sort__check4" type="checkbox" />L
                                    </label>
                    ...
                    <div class="description__button">
                        <a class="description__button__link" href="cart.html"><svg width="27" height="25" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="description__product-box">
